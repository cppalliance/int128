...
image::../arm64_benchmarks.png[ARM64 Benchmark Results, width=100%]

image::../arm64_relative_performance.png[ARM64 Relative Performance, width=100%]
...
image::../x86_benchmarks.png[x86_32 Benchmark Results, width=100%]

image::../x86_relative_performance.png[x86_32 Relative Performance, width=100%]
...
image::../x64_benchmarks.png[x64 Benchmark Results, width=100%]

image::../x64_relative_performance.png[x64 Relative Performance, width=100%]
